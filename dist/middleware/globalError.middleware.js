...
const glboalErrorHandling = (err, req, res, next) => {
    if (err instanceof apiError_util_1.default) {
    ...
    const errorResponse = new apiError_util_1.default(err.message || 'An unexpected error occurred', err.statusCode || 500, err.details || null);
